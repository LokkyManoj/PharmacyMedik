...
<body>
    <header>
        ...
        <nav class="top-nav" >
        <ul>
      <li>  <div class="home-icon" id="home-icon">
            <a href="PharmacyHome.jsp" style="text-decoration: none; class="home"> <img
							src="images1/homeicon.png" alt="Cart Icon"></a>
           
        </div></li>
        
      <li>  <div class="cart-icon" id="cart-icon">
            <a href="ViewCartServlet" style="text-decoration: none; class="cart"><img
							src="images1/icons8-cart-32.png" alt="Cart Icon"></a>
							       </div></li>
							       </ul>
							       </nav>
    </header>
    ...
    function searchProducts() {
        ...
        for (let i = 0; i < productCards.length; i++) {
            ...
            const cardCategory = productCards[i].getAttribute('data-category');
            
            if (category === "medicine") {
                if (filter === "") {
                    productCards[i].style.display = 'none';
                } else {
                    if (productName.includes(filter) && cardCategory === category) {
